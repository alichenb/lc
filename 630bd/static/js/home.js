...
(function () {
    ...
    var initLocation = function () {
        ...
        if (url.length > 2) {
            cm.ajax("index.php?m=Index&c=Space&a=ajax_profile", {
                id: url[2]
            }, function (r) {
    ...
    var initHomeNav = function () {
        ...
        cm.get("submit_ok").onclick = function () {
            ...
            cm.ajax("index.php?m=Index&c=User&a=editPass", {
                ori_pass: Original_pass,
                pwd: pass1
            }, function (res) {
        ...
        //导航栏下的 “账单明细”
        cm.get("billing_details").onclick = function () {
            home.showSetting(cm.get, "4");
        }
        //左侧菜单的“用户头像”（杰）
        ...
        key.onmouseup = key.onkeyup = function () {
            ...
            if (cm.trim(newVal) != "" && newVal != lastVal) {
                ...
                time4search = setTimeout(function () {
                    cm.ajax("index.php?m=Index&c=User&a=searchLike", {
                        key: newVal,
                        gender: cm.getUserGender()
                    }, function (res) {
    ...
    this.showSetting = function (p, n) {
        ...
        function navSET(n) {
            //先找到这些导航“id”
            var ids = ["setli_1", "setli_2", "setli_3", "setli_4"];
    ...
    function device_detect() {
        ...
        if (bool) {
            var newUrl = "index.php?m=Wap&" + bool;
        } else {
            var newUrl = "index.php?m=Wap";
        }
