...
var common = function () {
    ...
    this.showChat = function (u,mark) {
        // self.ajax('http://' + window.location.host + '/index.php?m=Index&c=Chat&a=checkuserlimit', '', function (msg) {
    ...
    this.showSpot = function () {
        if (self.isEnough(10)) {
            if (self.checkIcon()) {
                self.ajax("index.php?m=Index&c=Spot&a=add", {}, function (res) {
